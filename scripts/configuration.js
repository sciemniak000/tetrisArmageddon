...
export const black_window_central_block3_y = 22;

export const black_window_central_block4_x = 30;
export const black_window_central_block4_y = 25;

export const black_window_central_block5_x = 38;
export const black_window_central_block5_y = 30;

export const black_window_central_block6_x = 30;
export const black_window_central_block6_y = 23;

export const black_window_central_block7_x = 30;
...
// win and lose screen
export const win_screen_label_x = 12;
export const win_screen_label_y = 280;
export const win_screen_label_font = "bold 45px ComicSans";
export const win_screen_label = "Level passed!";
export const final_win_screen_label_x = 10;
export const final_win_screen_label_y = 280;
export const final_win_screen_label_font = "bold 36px ComicSans";
export const final_win_screen_label = "Congratulations!";
export const lose_screen_label_x = 20;
export const lose_screen_label_y = 240;
export const lose_screen_label_font = "bold 45px ComicSans";
export const lose_screen_label = "You lose.";
export const lose_screen_label_q_x = 20;
export const lose_screen_label_q_y = 290;
export const lose_screen_label_font_q = "bold 25px ComicSans";
